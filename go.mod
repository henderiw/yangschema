...
require (
	github.com/sdcio/config-server v0.0.27
...
require (
	...
	github.com/openconfig/gnmic/pkg/api v0.1.5 // indirect
	...
	github.com/sdcio/data-server v0.0.39 // indirect
	github.com/sdcio/sdc-protos v0.0.25 // indirect
